...
beautiful.init("/home/marduk/dotfiles/awesome/default/theme.lua")
...
-- I suggest you to remap Mod3 to another key using xmodmap or other tools.
...
globalkeys = awful.util.table.join(
    ...
    function ()
        ...
        awful.menu.menu_keys.up = { "Control_L" }
    ...
    awful.key({ modkey },"d",
        function()
            awful.util.spawn_with_shell(
                "export LANGUAGE=en_US.UTF8;dmenu-launch -b -i -fn " ..
    ...
    awful.key({ modkey, "Shift"}, "r",
        function ()
            awful.util.spawn("gksudo reboot")
        end),

    awful.key({ modkey, "Shift"}, "s",
        function ()
            awful.util.spawn("gksudo shutdown")
        end),
