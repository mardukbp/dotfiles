...
class LocalConfig(multiconfig.DefaultConfig):
    ...
    data_dir = '/home/marduk/Personal/moin/data/' #os.path.join(instance_dir, 'data', '') # path with trailing /

    # Where system and help pages are (you may exclude this from backup):
    data_underlay_dir = '/home/marduk/Personal/moin/underlay/' #os.path.join(instance_dir, 'underlay', '') # path with trailing /
